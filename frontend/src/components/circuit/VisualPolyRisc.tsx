...
export default function VisualPolyRisc(props: VisualProps) {
  ...
  return (
    <svg viewBox="0 0 1231 400" class="w-full h-full" style="max-height: 100%; max-width: 100%;" preserveAspectRatio="xMidYMid meet" fill="none">
      ...
      />
      <use href="#pc-inst" class="circuit-wire" />
      <path id="inst-ir"
      ...
      />
      <use href="#inst-ir" class="circuit-wire" />
      <path id="pc-mux"
      ...
      />
      <use href="#mux-reg" class="circuit-wire" />
      <path id="ir-reg"
      ...
      />
      <use href="#ir-reg" class="circuit-wire" />
      <path id="ir-rdst"
      ...
      />
      <use href="#ir-rdst" class="circuit-wire" />
      <path id="ir-rsrc1"
      ...
      />
      <use href="#ir-rsrc1" class="circuit-wire" />
      <path id="ir-rsrc2"
      ...
      />
      <use href="#ir-rsrc2" class="circuit-wire" />
      <path id="ir-pc"
      ...
      />
      <use href="#reg-A" class="circuit-wire" />
      <path id="reg-B"
      ...
      />
      <use href="#reg-B" class="circuit-wire" />
      <path id="alu-reg"
      ...
      />
      <use href="#alu-reg" class="circuit-wire" />
      <path id="reg-data"
      ...
      />
      <use href="#reg-data" class="circuit-wire" />
      <path id="reg-addr"
      ...
      />
      <use href="#reg-addr" class="circuit-wire" />
      <path id="mem-reg"
      ...
      />
      <use href="#mem-reg" class="circuit-wire" />
      <path id="ir-control1"
      ...
      />
      <use href="#ir-control1" class="circuit-wire" />
      <path id="ir-control2"
      ...
      />
      <use href="#ir-control2" class="circuit-wire" />
      ...
      <use href="#pc-inst" class={fetch() ? "fill-red-500" : ""} />
      <use href="#inst-ir" class={fetch() ? "fill-red-500" : ""} />
      <use href="#pc-mux" class={nop() ? "fill-red-500" : ""} />
      <use href="#mux-reg" class={opTwoReg() || opThreeReg() || load() || loadI() ? "fill-red-500" : ""} />
      <use href="#ir-reg" class={loadI() ? "fill-red-500" : ""} />
      <use href="#ir-rdst" class={opTwoReg() || opThreeReg() || load() || loadI() ? "fill-red-500" : ""} />
      <use href="#ir-rsrc1" class={opTwoReg() || opThreeReg() || load() || store() ? "fill-red-500" : ""} />
      <use href="#ir-rsrc2" class={opThreeReg() || store() ? "fill-red-500" : ""} />
      <use href="#ir-pc" class={branching() ? "fill-red-500" : ""} />
      <use href="#reg-A" class={opTwoReg() || opThreeReg() ? "fill-red-500" : ""} />
      <use href="#reg-B" class={opThreeReg() ? "fill-red-500" : ""} />
      <use href="#alu-reg" class={opTwoReg() || opThreeReg() ? "fill-red-500" : ""} />
      <use href="#reg-data" class={store() ? "fill-red-500" : ""} />
      <use href="#reg-addr" class={load() || store() ? "fill-red-500" : ""} />
      <use href="#mem-reg" class={load() ? "fill-red-500" : ""} />
      <use href="#ir-control1" class={decode() ? "fill-red-500" : ""} />
      <use href="#ir-control2" class={decode() ? "fill-red-500" : ""} />
      ...
      <ObscureMemory name="Mémoire d'instruction" class="fill-green-700" x={313} y={70}>
        <text x={5} y={182} dominant-baseline="middle" fill="black">addr</text>
        <text x={165} y={182} dominant-baseline="middle" text-anchor="end" fill="black">data_in</text>
      </ObscureMemory>

      <ObscureMemory name="Registres" class="fill-yellow-300" x={757} y={70} hasControlSignal={true} controlName="wr_reg" isWritable={opTwoReg() || opThreeReg() || load() || loadI()}>
        <text x={5} y={35} dominant-baseline="middle" fill="black">data_in</text>
        <text x={5} y={201} dominant-baseline="middle" fill="black">rdst</text>
        <text x={5} y={238} dominant-baseline="middle" fill="black">rsrc1</text>
        <text x={5} y={275} dominant-baseline="middle" fill="black">rsrc2</text>
        <text x={165} y={122.5} dominant-baseline="middle" text-anchor="end" fill="black">A</text>
        <text x={165} y={267.5} dominant-baseline="middle" text-anchor="end" fill="black">B</text>
      </ObscureMemory>
      <ObscureMemory name="Mémoire de données" class="fill-green-500" x={1101} y={70} hasControlSignal={true} controlName="wr_mem" isWritable={store()}>
        <text x={5} y={132.5} dominant-baseline="middle" fill="black">addr</text>
        <text x={5} y={264} dominant-baseline="middle" fill="black">data_in</text>
        <text x={165} y={190} dominant-baseline="middle" text-anchor="end" fill="black">data_out</text>
      </ObscureMemory>

      <RegisterBox name="PC" class="bg-blue-600/20 border border-blue-500 reg-bg-blue reg-text-blue" number={pcVal()} x={134.5} y={137.5} isActivated={nop() || branching()} registerSize={REGISTER_12_BIT} />
      <RegisterBox name="IR" class="bg-purple-600/20 border border-purple-500 reg-bg-purple reg-text-purple" number={irVal()} x={467.5} y={137.5} isActivated={fetch()} registerSize={REGISTER_28_BIT} />

      {/* === Junction dots === */}
      <circle cx="282" cy="170" r="5" class={fetch() || nop() ? "fill-red-500" : "fill-main-600"} />
      <circle cx="616" cy="170" r="5" class={opTwoReg() || opThreeReg() || branching() || load() || store() || loadI() ? "fill-red-500" : "fill-main-600"} />
      <circle cx="880" cy="217" r="5" class={opThreeReg() || store() ? "fill-red-500" : "fill-main-600"} />
